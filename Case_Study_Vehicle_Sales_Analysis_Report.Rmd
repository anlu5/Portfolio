...
```{r look at data}
cars_df <- read.csv("car_sales_cleaned.csv")
tibble(cars_df)
```
...
```{r visualizing top 5 makes, echo=FALSE}
...
```{r visualizing top 5 car makes seperating vehicle types, echo=FALSE}
ggplot(data = top_5) +
...
```{r visualizing highlighted ford/nissan cars, echo=FALSE}
...
```{r visualizing highlighted ford/nissan SUV, echo=FALSE}
...
```{r visualizing ford/nissan truck, echo=FALSE}
...
```{r visualizing ford/nissan van, echo=FALSE}
